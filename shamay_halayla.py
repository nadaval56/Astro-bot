...
• קידוש לבנה – הצג *אך ורק* את הטקסט שמופיע בשדה "קידוש לבנה / ברכת הלבנה" למעלה. אם השדה ריק או "לא רלוונטי" – *אל תזכיר קידוש לבנה בכלל*, אפילו לא במשפט אחד, אפילו לא מידע כללי
• "הכנת קרקע" – אם יש אירוע מעניין בימים הקרובים, זרוק עליו מילה היום

תאריך עברי:
• היום העברי מתחיל בצאת הכוכבים (~40 דקות אחרי שקיעה)
• אם השעה היא אחרי השקיעה – אנחנו כבר ביום העברי הבא
• ראש חודש / שבת / חג שמתחיל הלילה – לא "מחר", אלא "הלילה" או "עוד כמה שעות"

סיום:
• סיים *כל* הודעה במשפט: "שאו מרום עיניכם וראו מי ברא אלה 🌌"
...
• הקורא שלא קרא – צריך להתחרט. לא מאמר, לא דוח – הודעה חדה וקולעת"""
    ...
    # ══════════════════════════════════════════
    DYNAMIC_DATA = f"""לפני שתכתוב – חפש באינטרנט:
1. *חדשות חלל השבוע* – תגליות של טלסקופ האבל/ג'יימס וב, נחיתות/שיגורים מיוחדים, גילויים חדשים
2. אירועים אסטרונומיים – שביטים, ליקויים, מטר מטאורים, Starlink מישראל
3. אירועים בולטים השבוע בתחום החלל והאסטרונומיה

*חשוב:* חדשות חלל מעניינות (תגלית, שיגור, גילוי) עדיפות על תיאור טכני של מיקום כוכב לכת!
