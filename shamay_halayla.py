...
# (הוקדם מ-11:00 יחד עם הקדמת ריצת הצהריים ל-07:00 UTC – ראו astronomy_bot.yml)
...
SEND_WINDOW_START = (9, 0)     # 09:00 – לא שולחים לפני
...
def get_moon_observation_recommendation(age: float, pct: int,
    ...
    if not waxing and age < 23.0:
        base = ("🌖 *ירח פוחת* – הירח עולה מאוחר, כך שבתחילת הלילה השמיים חשוכים "
                "ומצוינים ל*תצפית כוכבים*. בשעות הקטנות, כשהירח גבוה, הצללים חוזרים "
...
def main():
    ...
    # ── שער חלון השעות ────────────────────────────────
    # ריצה שהתעכבה (או הופעלה) מחוץ ל-09:00–22:30 נעצרת כאן,
